...
export default function PrintButton() {
  return (
    <button className={styles.PrinterButton} type="button">
      <div className={styles.PrinterButton__image}>
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
          ...
          className={styles.PrinterButton__svg}
        >
          <path
      ...
      <Paragraph className={styles.PrinterButton__text}>PRINT</Paragraph>
    </button>
  );
}
